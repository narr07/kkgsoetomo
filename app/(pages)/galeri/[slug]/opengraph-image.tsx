...
export default async function Image({ params }: Props) {
  ...
  try {
    ...
    // Ambil URL thumbnail dari gallery jika ada
    ...
    // Jika ada thumbnail, gunakan itu
    if (imageUrl) {
      return new ImageResponse(
        (
          <div
    ...
    // Fallback: jika tidak ada thumbnail, tampilkan dengan gradient
    return new ImageResponse(
      (
        <div
          style={{
        ...
        >
          ...
          >
            ...
            >
              {gallery.description || 'Dokumentasi Kegiatan KKG dr. Soetomo'}
            </p>
          </div>
        </div>
      ),
